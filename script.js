const currentTime = document.querySelector("h1"),
    ...
    alarmClock = document.querySelector('.alarm');

let alarmTime, isAlarmSet
let ringtone = new Audio("./files/alarmSound.mp3");
...
setInterval(() => {
    ...
    if (alarmTime === `${h}:${m} ${ampm}`) {
        ringtone.play();
        ringtone.loop = true;
        alarmClock.classList.add('animation')
...
function setAlarm() {
    if (isAlarmSet) {
        ...
        alarmClock.classList.remove('animation')
